...
client.on("message", async message => {
  ...
  if(command === "retain") {
	...
	if(command === "adderal") {
		...
		if(quote = 3) message.channel.send(">>> So note to self don’t ask those types of questions to Osseley...I’ve been detained 3 times they call me...lil adderall") return
		if(quote = 4) message.channel.send(">>> Alright I don’t know why I’m detained. I know all my detainments but not this one. But you know what they call me....you already guessed it........lil....adderall.") return
		...
		if(quote = 6) message.channel.send(">>> Aight..aight.. so you know stuff went down I was about to drop my new song “Osseley do you CAP with me” you know aight...rubs hands...and she don’t like it so I was like “aight”. Bro I swear to god she was like “I ain’t CAP’n with you”. BAM BAM. But you know what they call me.....Lil Adderall...") return
